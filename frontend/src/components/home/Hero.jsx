  ...
  return (
    <div className='h-screen md:h-[75vh] flex flex-col md:flex-row items-center justify-center'>
      <div className = "w-full mb-12 md:mb-0 lg:w-3/6 flex flex-col items-center lg:items-start justify-center">
        ...
        <div className='mt-5'>
          <Link to = "/all-books" className='text-yellow-200 text-center text-xl lg:text-2xl font-semibold border border-yellow-100 px-10 py-3 hover:bg-zinc-800 rounded-full'>Discover Books</Link>
        </div>
      </div>

      <div className = "w-full lg:w-3/6 h-auto lg:h-[100%] flex items-center justify-center">
        <img className='h-2/4 w-2/4' src="https://images.icon-icons.com/12/PNG/256/books_library_1767.png" alt="hero" />
      </div>
    </div>
  )
}
